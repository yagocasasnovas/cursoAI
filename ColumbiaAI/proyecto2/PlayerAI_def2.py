...
class PlayerAI(BaseAI):
	...
	def heuristic(self,node):
		...
		kspread = 5
		kspread2 = 5
		emptyleft2 = self.emptyleft(node)
		kemptyleft2 = -10000
		
		
		return kspread2*self.spread2(node,2) + KfreeCells*freeCells + kemptyleft2*emptyleft2
	...
	def emptyleft(self,node):
		
		if node.getCellValue([0,0]) == 0:
			return 1
