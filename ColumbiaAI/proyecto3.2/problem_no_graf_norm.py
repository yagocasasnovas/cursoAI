...
learning_rates = [0.001, 0.005, 0.01, 0.05, 0.1, 0.5, 1.0, 5.0, 10.0, 0.97]
...
for idx, lr in enumerate(learning_rates):
	...
	for it in range(iterations):
		...
		"print str(betas[0]) + ' ' + str(suma_parcial0) + ' ' + str(lr/number_samples)"
	...
	print str(lr) + ' ' + str(it+1) + ' ' + str(betas[0]) + ' ' + str(betas[1])+ ' ' + str(betas[2])
